            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <?php foreach ($employees as $emp): ?>
                        <tr data-name="<?= strtolower($emp['name']) ?>" data-email="<?= strtolower($emp['email']) ?>"
                            data-department="<?= strtolower($emp['department'] ?? '') ?>"
                            ...
                            <td>
                                ...
                                <button type="button"
                                    class="btn btn-sm <?= $emp['status'] ? 'btn-outline-danger' : 'btn-outline-success' ?> toggleEmployeeStatus"
